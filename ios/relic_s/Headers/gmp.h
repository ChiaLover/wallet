...
#define __GMP_CC "/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang   -disable-llvm-optzns -O3 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator14.5.sdk -Wno-error -Wno-implicit-function-declaration -arch x86_64 -miphoneos-version-min=10.0 -no-integrated-as -target x86_64-apple-darwin -fvisibility=hidden"
