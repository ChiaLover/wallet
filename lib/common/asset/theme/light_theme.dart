...
class LightTheme extends WTheme {
  ...
  TypeSystem get typeSystem => TypeSystem(
        ...
        header5: ScaleCategory(size: 24, letterSpacing: 0.15, fontWeight: FontWeight.w500),
        header6: ScaleCategory(size: 18, letterSpacing: 0.15, fontWeight: FontWeight.w500),
        subtitle1: ScaleCategory(size: 16, letterSpacing: 0.15),
        subtitle2: ScaleCategory(size: 14, letterSpacing: 0.1, color: WColors.osloGray),
